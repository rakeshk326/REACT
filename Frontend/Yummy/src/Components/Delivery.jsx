    ...
    <div className='px-4 pt-20 bg-white mt-8'>
        ...
        <div className='mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col md:py-8 justify-center'>
                <p className='text-green-600 mx-2 font-bold text-xl'>Get the App</p>
                <h1 className='text-xl font-bold mx-2 mt-2 md:text-3xl lg:text-3xl'>Limitless Convenience on demand</h1>

                <p className='font-sans mx-2 mt-4 md:hidden lg:hidden'>Yummy is a delightful restaurant offering a diverse menu of both tasty vegetarian and non-vegetarian delights. Enjoy the heavenly ambiance as we cater <br/> a wide range of tastes. Our commitment to culinary excellence extends to our dedicated delivery service, bringing exceptional flavors to the comfort of your home. For a delightful dining adventure!</p>
                ...
                <button className='bg-black text-green-500 font-semibold w-[120px] mx-2 mt-5 rounded-md py-2'>Coming Soon</button>
            </div>
        </div>
    </div>
