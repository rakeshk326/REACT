    ...
    <div className='px-4 pt-20 bg-white mt-8'>
        ...
        <div className='mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col md:py-8 justify-center'>
                ...
                <p className='font-sans mx-2 mt-4 md:hidden lg:hidden'>Our commitment to culinary excellence extends to our dedicated delivery service, bringing exceptional flavors to the comfort of your home. For a delightful dining adventure!</p>
