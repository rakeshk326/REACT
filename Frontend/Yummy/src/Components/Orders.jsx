    ...
    <>
      ...
      {cartItems.length === 0 && !confirm && (
        <div className='flex flex-col justify-center items-center mt-56'>
          ...
          <div className='text-center font-normal md:font-semibold text-xl mt-2'>Your cart is empty</div>
        </div>
      )}
      ...
      {confirm && (
        <div className='flex flex-col justify-center items-center mt-56'>
          ...
          <div className='text-center font-normal md:font-semibold text-xl mt-4'>Your order is placed</div>
        </div>
      )}
